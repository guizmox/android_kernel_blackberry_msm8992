...
#define MDSS_BRIGHT_TO_BL(out, v, bl_max, max_bright) do { \
    /* mapping : from android 25 to 255 -> bl from 30 to 40 (then 255) */ \
    static const u16 brightness_lut[256] = { \
        1,  3,  4,  5,  6, 7, 8, 9,  /* 0-7 */ \
        10, 11, 12, 13, 14, 15, 16, 17,  /* 8-15 */ \
        18, 19, 20, 21, 22, 23, 24, 24,  /* 16-23 */ \
        25, 25, 26, 26, 27, 27, 27, 28,  /* MIDDLE OF THE SLIDER 24-31 */ \
        28, 28, 29, 29, 29, 29, 30, 30,  /* 32-39 */ \
        30, 30, 31, 31, 31, 31, 31, 32,  /* 40-47 */ \
        32, 32, 32, 32, 33, 33, 33, 33,  /* 48-55 */ \
        33, 33, 34, 34, 34, 34, 34, 34,  /* 56-63 */ \
        35, 35, 35, 35, 35, 35, 35, 36,  /* 64-71 */ \
        36, 36, 36, 36, 36, 36, 37, 37, /* 72-79 */ \
        37, 37, 37, 37, 37, 37, 38, 38, /* 80-87 */ \
        38, 38, 38, 38, 38, 38, 39, 39, /* 88-95 */ \
		39, 39, 39, 39, 39, 39, 39, 40, /*> 103 */ \
		40, 40, 40, 40, 40, 40, 40, 40, /*> 111 */ \
		41, 41, 41, 41, 41, 41, 41, 41, /*> 119 */ \
		41, 41, 42, 42, 42, 42, 42, 42, /*> 127 */ \
		42, 42, 42, 42, 43, 43, 43, 43, /*> 135 */ \
		43, 43, 43, 43, 43, 43, 43, 44, /*> 143 */ \
		44, 44, 44, 44, 44, 44, 44, 44, /*> 151 */ \
		44, 44, 45, 45, 45, 45, 45, 45, /*> 159 */ \
		45, 45, 45, 45, 45, 45, 46, 46, /*> 167 */ \
		46, 46, 46, 46, 46, 46, 46, 46, /*> 175 */ \
		46, 46, 47, 47, 47, 47, 47, 47, /*> 183 */ \
		47, 47, 47, 47, 47, 47, 47, 48, /*> 191 */ \
		48, 48, 48, 48, 48, 48, 48, 48, /*> 199 */ \
		48, 48, 48, 48, 49, 49, 49, 49, /*> 207 */ \
		49, 49, 49, 49, 49, 49, 49, 49, /*> 215 */ \
		49, 50, 50, 52, 54, 56, 58, 60, /*> 223 */ \
		63, 66, 69, 73, 77, 81, 85, 90, /*> 231 */ \
		95, 100, 105, 110, 115, 120, 125, 130, /*> 239 */ \
		135, 140, 145, 150, 160, 170, 180, 190, /*> 247 */ \
		200, 210, 220, 230, 240, 250, 255, 255 /*> 255 */ \
    }; \
    out = brightness_lut[(v)]; \
} while (0)

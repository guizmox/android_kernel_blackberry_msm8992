...
#define ABS_MT_TOUCH_CANCEL	0x3e	/* Cancel the previous touch events */
#define ABS_MT_TOUCH_EDGE	0x3f	/* Notification indicates the touches are along the Edge */
...
#define SW_KEYPAD_TRANSITION	0x13  /* set = keypad slide transition */
#define SW_SMART_FLIP		0x14  /* set = Smart (Windowed) Flip case event */
#define SW_MAX			0x20
